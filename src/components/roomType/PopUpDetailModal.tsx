...
import { JDmodal, IUseModal, JDalign, JDbadge, JDslider, JDslide, JDphotoFrame, JDtypho, JDdayPicker, JDbutton, JDselect, toast } from '@janda-com/front';
...
export const PopUpDetailPage: React.FC<IProp> = ({roomTypeContext,availableCount,roomType,handleDoResvBtn,resvContext,images,isSoldOut,popUpProductClose,productVeiwerModal,DailyPrice}) => {
